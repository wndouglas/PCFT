	...
	namespace numerics
	{
		...
		public:
			...
			IFourierTransformer::ComplexVec execute(
				const IFourierTransformer* mTransformer,
		...
		private:
			...
			void calculateLittleh(IFourierTransformer::ComplexVec& hOut, const IFourierTransformer* transformer, int lambda, const int N, const double P, const double dx) const;
			void calculateLittlegTilde(IFourierTransformer::ComplexVec& gOut, const IFourierTransformer* transformer, int lambda, const int N, const double P, const double dx) const;
			void calculateGTilde(IFourierTransformer::ComplexVec& GTilde, const IFourierTransformer::ComplexVec& gTilde, const IFourierTransformer* transformer, const double P) const;
